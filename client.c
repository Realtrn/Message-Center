...
// thread function to send mess
void send_msg_handler()
{
	char message[LENGTH] = {}; // array to save the contents are typed 
	char buffer[LENGTH + 32] = {}; // array to save mess which is sent to other clients
	while (1)
	{
		printf("\033[0;32m") ; 
...
// thread function to receive mess
void recv_msg_handler()
{
	char message[LENGTH] = {}; // mess's received is saved here
	while (1)
	{
